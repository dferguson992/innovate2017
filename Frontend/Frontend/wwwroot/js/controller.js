...
SYMPHONY.remote.hello().then(function (data) {
    ...
    SYMPHONY.application.register("hello", ["modules", "applications-nav", "ui", "share", "entity"], ["hello:controller", "message:controller"]).then(function (response) {
        ...
        navService.add("hello-nav", "Save My Info", "hello:controller");

        // LEFT NAV: Add an extra left navigation item that can be removed by clicking on the "Remove Left Nav Item Button"
        navService.add("hello-nav-remove", "Removable Save My Info", "hello:controller");
        ...
        uiService.registerExtension("single-user-im", "save-im", "hello:controller", { label: "Save-IM Button", data: { "datetime": Date() } });
        uiService.registerExtension("multi-user-im", "save-mim", "hello:controller", { label: "Save-MIM Button" });
        ...
        helloControllerService.implement({
            ...
            trigger: function (uiClass, id, payload, data) {
                if (uiClass == "single-user-im") {
                    console.log('Save-IM button was clicked on ' + data.datetime + '.');
                } else if (uiClass == "multi-user-im") {
                    console.log('Save-MIM button was clicked.');
                } else if (uiClass == "room") {
                    console.log('Save-Room button was clicked.');
